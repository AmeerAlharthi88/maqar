  ...
  return (
    <AppShell>
      <div className="bg-white border-b border-[#E2E8F0] px-4 py-3 flex items-center gap-3" dir="rtl">
        <div className="w-8 h-8 rounded-xl bg-[#0A3C36] flex items-center justify-center flex-shrink-0">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
          </svg>
        </div>
        <div>
          <h1 className="text-sm font-bold text-[#102A43]">التوثيق الرسمي</h1>
          <p className="text-xs text-[#627D98]">احصل على شارة الوسيط الموثوق</p>
        </div>
      </div>
      <KYCVerificationForm />
    </AppShell>
