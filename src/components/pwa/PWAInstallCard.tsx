...
export function PWAInstallCard() {
  ...
  if (ios) {
    return (
      <div className="bg-white rounded-2xl border border-[#F0EBE3] p-4" dir="rtl">
        <p className="text-sm font-bold text-[#1E1E1E] mb-2">
          📱 أضف مقر إلى الشاشة الرئيسية
        </p>
        <p className="text-xs text-[#7A6B5E] mb-3">
          للحصول على تجربة التطبيق الكاملة على iPhone:
        </p>
        <ol className="space-y-2 text-xs text-[#7A6B5E] list-none">
          <li className="flex items-start gap-2">
            <span className="font-bold text-[#C65D3B]">١.</span>
            اضغط على أيقونة المشاركة{" "}
            <span aria-label="أيقونة المشاركة">⬆️</span> في متصفح Safari
          </li>
          <li className="flex items-start gap-2">
            <span className="font-bold text-[#C65D3B]">٢.</span>
            اختر «إضافة إلى الشاشة الرئيسية»
          </li>
          <li className="flex items-start gap-2">
            <span className="font-bold text-[#C65D3B]">٣.</span>
            اضغط «إضافة» للتأكيد
          </li>
        </ol>
      </div>
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#F0EBE3] p-4" dir="rtl">
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-xl bg-[#C65D3B] flex items-center justify-center flex-shrink-0">
          <span className="text-white font-bold text-base">م</span>
        </div>
        <div>
          <p className="text-sm font-bold text-[#1E1E1E]">ثبّت تطبيق مقر</p>
          <p className="text-xs text-[#7A6B5E]">وصول سريع · يعمل بدون إنترنت</p>
        </div>
      </div>
      <button
        onClick={trigger}
        className="w-full py-3 rounded-xl bg-[#C65D3B] text-white text-sm font-bold min-h-[44px]"
