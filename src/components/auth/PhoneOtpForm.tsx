...
export function PhoneOtpForm() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6" dir="rtl">
      ...
      <h1 className="text-2xl font-bold text-[#102A43] mb-1">أهلاً بك في مقر</h1>
      <p className="text-sm text-[#627D98] text-center mb-8 max-w-xs leading-relaxed">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xs space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 border border-[#E2E8F0] rounded-2xl bg-white overflow-hidden focus-within:border-[#0A3C36] transition-colors">
            {/* Country prefix */}
            <span className="flex items-center gap-1.5 px-3 py-3.5 border-l border-[#E2E8F0] text-sm font-bold text-[#102A43] shrink-0 bg-[#F8F9FA]">
              🇴🇲 +968
            </span>
            <input
              type="tel"
        ...
        <button
          ...
          className="w-full py-3.5 rounded-2xl bg-[#0A3C36] text-white font-bold text-sm disabled:opacity-50 flex items-center justify-center gap-2 transition-opacity hover:bg-[#082E29]"
        >
          {isLoading ? (
            <>
