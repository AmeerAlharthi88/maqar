  ...
  return (
    <label htmlFor={radioId} className="flex items-start gap-3 cursor-pointer group">
      <div className="relative flex-shrink-0 mt-0.5">
        ...
        <div
          className={cn(
            "w-5 h-5 rounded-full border-2 border-[#E2E8F0] bg-white transition-all duration-150",
            "peer-checked:border-[#0A3C36]",
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-2.5 h-2.5 rounded-full bg-[#0A3C36] opacity-0 peer-checked:opacity-100 transition-opacity scale-75 peer-checked:scale-100" />
        </div>
      </div>
      {(label ?? helperText) && (
