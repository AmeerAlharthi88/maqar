    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-[#FAF7F4] rounded-xl py-2 text-center">
          <p className="text-sm font-bold text-[#1E1E1E]">{agency.stats.activeListings}</p>
          <p className="text-[10px] text-[#A89480]">إعلان نشط</p>
        </div>
        <div className="bg-[#FAF7F4] rounded-xl py-2 text-center">
          <p className="text-sm font-bold text-[#1E1E1E]">{agency.stats.totalAgents}</p>
          <p className="text-[10px] text-[#A89480]">وسيط</p>
        </div>
        <div className="bg-[#FAF7F4] rounded-xl py-2 text-center">
          <p className="text-sm font-bold text-[#1E1E1E]">{agency.foundedYear}</p>
