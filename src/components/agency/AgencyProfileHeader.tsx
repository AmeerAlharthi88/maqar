    ...
    <div className="bg-white border-b border-[#E2E8F0]" dir="rtl">
      <div className="px-4 py-5">
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1 min-w-0 pt-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-lg font-bold text-[#102A43]">{agency.nameAr}</h1>
              {agency.isVerified && (
                <span className="flex items-center gap-1 bg-[#E6F0EF] px-2 py-0.5 rounded-full">
                  ...
                  <span className="text-[10px] font-semibold text-[#0A3C36]">موثّقة</span>
                </span>
              )}
            </div>
        ...
        {agency.descriptionAr && (
          <p className="text-sm text-[#627D98] leading-relaxed mb-4">{agency.descriptionAr}</p>
        )}
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          <div className="bg-[#F8F9FA] rounded-xl py-2 text-center">
            <p className="text-base font-bold text-[#102A43]">{agency.stats.activeListings}</p>
            <p className="text-[10px] text-[#627D98]">إعلان نشط</p>
          </div>
          <div className="bg-[#F8F9FA] rounded-xl py-2 text-center">
            <p className="text-base font-bold text-[#102A43]">{agency.stats.soldListings}</p>
            <p className="text-[10px] text-[#627D98]">صفقة</p>
          </div>
          <div className="bg-[#F8F9FA] rounded-xl py-2 text-center">
            <p className="text-base font-bold text-[#102A43]">{agency.stats.totalAgents}</p>
            <p className="text-[10px] text-[#627D98]">وسيط</p>
          </div>
          <div className="bg-[#F8F9FA] rounded-xl py-2 text-center">
            <p className="text-base font-bold text-[#102A43]">{agency.foundedYear}</p>
