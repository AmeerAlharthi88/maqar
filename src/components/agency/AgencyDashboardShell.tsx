    ...
    return (
      <AppShell>
        ...
        <div className="px-4 py-12 text-center" dir="rtl">
          ...
          <h2 className="text-base font-bold text-[#102A43] mb-2">هذه الصفحة لمديري الوكالات</h2>
          <p className="text-sm text-[#627D98] mb-6 leading-relaxed">
            يتطلب الوصول إلى لوحة تحكم الوكالة صلاحيات مدير وكالة عقارية
          </p>
          <Link
            href={ROUTES.home}
            className="inline-block px-6 py-3 rounded-xl bg-[#F0F4F8] text-[#102A43] text-sm font-bold"
          >
            العودة إلى الرئيسية
          </Link>
        </div>
