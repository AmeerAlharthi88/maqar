    ...
    <div className="bg-white rounded-2xl border border-[#F0EBE3] px-4 py-4" dir="rtl">
      ...
      <div className="flex items-start justify-between gap-2 mb-3">
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-[#1E1E1E] line-clamp-2">{flag.listingTitleAr}</p>
          <p className="text-xs text-[#7A6B5E] mt-0.5">{flag.agentNameAr} · {flag.areaAr}</p>
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="bg-[#FAF7F4] rounded-xl py-2 text-center">
          ...
          <p className="text-[10px] text-[#A89480]">سعر الإعلان</p>
        </div>
        <div className="bg-[#FAF7F4] rounded-xl py-2 text-center">
          <p className="text-xs font-bold text-[#1E1E1E]">
            {flag.marketAvgPrice.toLocaleString("ar-OM")}
          </p>
          <p className="text-[10px] text-[#A89480]">متوسط السوق</p>
        </div>
        <div className="bg-[#FBF0EB] rounded-xl py-2 text-center">
          <p className="text-xs font-bold text-[#C65D3B]">-{flag.diffPct}٪</p>
          <p className="text-[10px] text-[#A89480]">أقل من السوق</p>
        </div>
      </div>

      {/* Threshold notice */}
      <div className="bg-[#FBF0EB] rounded-xl px-3 py-2 mb-3 flex items-start gap-2">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#C65D3B" strokeWidth="2" className="flex-shrink-0 mt-0.5">
          <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
          <line x1="12" y1="9" x2="12" y2="13" />
          <line x1="12" y1="17" x2="12.01" y2="17" />
        </svg>
        <p className="text-[10px] text-[#C65D3B] leading-relaxed">
      ...
      {flag.adminNote && (
        <div className="bg-[#FFF8E7] rounded-xl px-3 py-2 mb-3">
          ...
          <p className="text-xs text-[#7A6B5E]">{flag.adminNote}</p>
        </div>
      )}
      ...
      {isActionable && (
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex-1 min-w-[72px] py-2 rounded-xl bg-[#FBF0EB] text-[#C65D3B] text-xs font-bold"
          >
            رفض الإعلان
          </button>
        </div>
